...
class KcmapController extends BaseController{
    ...
    public function getAllObjects(){
        ...
        $all_objects = '';
        foreach (MapObjects::orderBy('title')->with('categories')->get() as $object):
            ...
            $single_object .= 'hintContent: "'.addslashes($object->title).'",},marker : {preset: "islands#dotIcon",iconColor: "'.$object->categories->color.'"}}';
