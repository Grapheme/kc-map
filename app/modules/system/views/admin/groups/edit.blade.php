    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 margin-bottom-25 margin-top-10">
        ...
        <div class="btn-group pull-left margin-right-10">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="{{ link::auth(" groups/edit/".$grp->id) }}">{{ $grp->desc }} ({{ $grp->count_users()
                    }})</a>
                </li>
                @endif
                @endforeach
        ...
        <div class="well">
            ...
            <fieldset>
                ...
                <section>
                    ...
                    @foreach($mod_actions as $module_name => $actions)
                        ...
                        <?php $title = isset($mod_info[$module_name]['title']) ? $mod_info[$module_name]['title'] : $module_name; ?>
                        <div class="row margin-bottom-10">
                            ...
                            <div class="col col-4">
                                <input type="checkbox"{{ $checked }} value="{{ $a }}" name="actions[{{ $module_name
                                }}][]" class="module-checkbox" id="act_{{ $module_name }}_{{ $a }}">
                                <i data-swchon-text="вкл" data-swchoff-text="выкл"></i>
                            </div>
                            @endforeach
                        </div>
            ...
            <footer>
                ...
                <button type="submit" autocomplete="off"
                        class="btn btn-success no-margin regular-10 uppercase btn-form-submit">
        ...
        <div class="well">
            ...
            <fieldset>
                ...
                <section>
                    ...
                    <div class="note">Страница, на которую попадет пользователь после авторизации. Можно оставить
                        пустым.
                    </div>
                </section>
